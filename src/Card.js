...
{this.props.movies && this.props.movies.filter(el => el.name.toLowerCase().includes(this.props.filtername.toLowerCase().trim()) && el.rating >=  this.props.filterstar).map(el => {
